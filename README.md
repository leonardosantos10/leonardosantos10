...
<br>
<div>
 <img src="https://skillicons.dev/icons?i=html,css,js,angular,react,nestjs,vite,vue,nuxtjs,jquery,bootstrap,tailwind,ts,nodejs,express,prisma,yarn,wordpress,c,cs,cpp,php,java,figma,Windows,powershell,"/>
